...
## iterate through the file and obtain the counts and hash each pair to a bucket in two different hash tables
...
## convert bucket hashtables to bit vectors
...
## now, pass two where we count the pairs of frequent items (using the bit vector to check as well)
